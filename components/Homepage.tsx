  ...
  return (
    <div className={`bg-background min-h-screen overflow-x-hidden relative ${isSillyMode ? 'chaos-mode' : ''}`}>
      ...
      <SillyBackground 
        ...
        onVideoEnd={() => setIsSillyMode(false)} 
      />
      ...
      <main className={`container mx-auto px-4 py-8 relative z-30 ${isSillyMode ? 'chaos-distort' : ''}`} style={{ '--chaos-duration': `${Math.random() * 2 + 1}s`, '--chaos-delay': `${Math.random()}s` } as React.CSSProperties}>
        <div className={`grid grid-cols-1 lg:grid-cols-3 gap-6 ${isSillyMode ? 'chaos-shake-hard' : ''}`} style={{ '--chaos-duration': `${Math.random() * 0.5 + 0.3}s`, '--chaos-delay': `${Math.random()}s` } as React.CSSProperties}>
          ...
          <div className={`space-y-4 ${isSillyMode ? 'chaos-random' : ''}`} style={{ '--random-duration': `${Math.random() * 3 + 1}s` } as React.CSSProperties}>
            <div className={`bg-gradient-to-br from-[#001830] to-[#000c24] border border-blue-400/30 rounded-lg p-4 hover:border-blue-300/50 transition-all duration-500 shadow-lg shadow-blue-500/20 ${isSillyMode ? 'chaos-opacity bg-opacity-30 backdrop-blur-sm' : ''}`} style={{ '--chaos-duration': `${Math.random() * 2 + 2}s`, '--chaos-delay': `${Math.random()}s` } as React.CSSProperties}>
                ...
                <div className={isSillyMode ? 'chaos-flip' : ''}>
                  <div className={isSillyMode ? 'chaos-text-wave' : ''} style={{ '--chaos-duration': `${Math.random() * 1.5 + 0.5}s`, '--chaos-delay': `${Math.random()}s` } as React.CSSProperties}>
                    <GlitchHeading 
                      ...
                      className={`text-xl text-blue-100 font-mono tracking-widest drop-shadow-[0_0_3px_rgba(147,197,253,0.5)] font-bold uppercase text-center ${isSillyMode ? 'chaos-colors' : ''}`}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex justify-center mb-4">
                <div className={isSillyMode ? 'chaos-text-spin' : ''} style={{ '--chaos-duration': `${Math.random() * 2 + 1}s`, '--chaos-delay': `${Math.random()}s` } as React.CSSProperties}>
                  <GlitchHeading 
                    ...
                    className={`text-lg text-blue-100 font-mono tracking-widest drop-shadow-[0_0_3px_rgba(147,197,253,0.5)] font-bold uppercase text-center ${isSillyMode ? 'chaos-colors' : ''}`}
                  />
                </div>
              </div>
          ...
          <div className="lg:col-span-2">
            <div className={`bg-gradient-to-br from-[#001830] to-[#000c24] border border-blue-400/30 rounded-lg p-6 hover:border-blue-300/50 transition-all duration-500 shadow-lg shadow-blue-500/20 ${isSillyMode ? 'chaos-opacity bg-opacity-30 backdrop-blur-sm' : ''}`}>
              <div className={`flex justify-between items-center mb-8 ${isSillyMode ? 'chaos-shake-hard' : ''}`} style={{ '--chaos-duration': `${Math.random() * 0.5 + 0.3}s`, '--chaos-delay': `${Math.random()}s` } as React.CSSProperties}>
                <div className={isSillyMode ? 'chaos-text-spin' : ''} style={{ '--chaos-duration': `${Math.random() * 2 + 1}s`, '--chaos-delay': `${Math.random()}s` } as React.CSSProperties}>
                  <GlitchHeading 
                    ...
                    as="h2"
                    className={`text-2xl md:text-3xl text-blue-100 font-mono tracking-widest drop-shadow-[0_0_3px_rgba(147,197,253,0.5)] font-bold uppercase ${isSillyMode ? 'chaos-colors' : ''}`}
                  />
                </div>
                <span className={`status-text recording text-sm ${isSillyMode ? 'chaos-text-spin chaos-colors' : ''}`} style={{ '--chaos-duration': `${Math.random() * 2 + 1}s`, '--chaos-delay': `${Math.random()}s` } as React.CSSProperties}>FINANCE RUNS EVERYTHING</span>
              </div>
              <div className={`relative flex flex-col md:flex-row gap-8 ${isSillyMode ? 'chaos-distort' : ''}`} style={{ '--chaos-duration': `${Math.random() * 2 + 1}s`, '--chaos-delay': `${Math.random()}s` } as React.CSSProperties}>
                <div className={`w-full md:w-1/2 ${isSillyMode ? 'chaos-pulse-grow' : ''}`} style={{ '--chaos-duration': `${Math.random() * 2 + 2}s`, '--chaos-delay': `${Math.random()}s` } as React.CSSProperties}>
                  <div className="flex flex-col">
                    <div className={`flex flex-col items-center gap-4 text-blue-100 font-mono text-lg tracking-wide ${isSillyMode ? 'chaos-text-wave' : ''}`} style={{ '--chaos-duration': `${Math.random() * 1.5 + 0.5}s`, '--chaos-delay': `${Math.random()}s` } as React.CSSProperties}>
        ...
        <div className={`mt-8 border border-blue-400/30 rounded-lg p-6 hover:border-blue-300/50 transition-all duration-500 shadow-lg shadow-blue-500/20 relative overflow-hidden ${isSillyMode ? 'chaos-opacity bg-opacity-30 backdrop-blur-sm chaos-bg' : 'bg-gradient-to-br from-[#001830] to-[#000c24]'}`}>
          <div className={`flex justify-between items-center mb-4 ${isSillyMode ? 'chaos-shake' : ''}`}>
            ...
            />
            <span className={`status-text recording text-sm ${isSillyMode ? 'chaos-colors chaos-bounce' : ''}`}>FINANCE RUNS EVERYTHING</span>
          </div>
