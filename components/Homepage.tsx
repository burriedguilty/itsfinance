      ...
      <main className="container mx-auto px-4 py-8 relative z-30">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-[#001830] to-[#000c24] border border-blue-400/30 rounded-lg p-6 hover:border-blue-300/50 transition-all duration-500 shadow-lg shadow-blue-500/20">
              <h3 className="text-2xl text-blue-100 font-mono tracking-widest drop-shadow-[0_0_3px_rgba(147,197,253,0.5)] mb-6 font-bold uppercase">We Speak in Gains</h3>
            ...
            <div className="bg-gradient-to-br from-[#001830] to-[#000c24] border border-blue-400/30 rounded-lg p-6 hover:border-blue-300/50 transition-all duration-500 shadow-lg shadow-blue-500/20">
              <h3 className="text-2xl text-blue-100 font-mono tracking-widest drop-shadow-[0_0_3px_rgba(147,197,253,0.5)] mb-6 font-bold uppercase">Align With the Market</h3>
            ...
            <div className="bg-gradient-to-br from-[#001830] to-[#000c24] border border-blue-400/30 rounded-lg p-6 hover:border-blue-300/50 transition-all duration-500 shadow-lg shadow-blue-500/20">
              <h3 className="text-2xl text-blue-100 font-mono tracking-widest drop-shadow-[0_0_3px_rgba(147,197,253,0.5)] mb-6 font-bold uppercase">Manifest $FINANCE</h3>
          ...
          {/* Main feature */}
          <div className="lg:col-span-2 bg-gradient-to-br from-[#001830] to-[#000c24] border border-blue-400/30 rounded-lg p-6 hover:border-blue-300/50 transition-all duration-500 shadow-lg shadow-blue-500/20">
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-3xl text-blue-100 font-mono tracking-widest drop-shadow-[0_0_3px_rgba(147,197,253,0.5)] font-bold">WEALTH IS HEALTH</h2>
              <span className="text-blue-300 text-sm font-mono tracking-wider animate-pulse drop-shadow-[0_0_2px_rgba(147,197,253,0.5)]">LIVE UPDATES</span>
            </div>
        ...
        <div className="mt-8 bg-gradient-to-br from-[#001830] to-[#000c24] border border-blue-400/30 rounded-lg p-6 hover:border-blue-300/50 transition-all duration-500 shadow-lg shadow-blue-500/20 relative overflow-hidden">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl text-blue-100 font-mono tracking-wider drop-shadow-[0_0_3px_rgba(147,197,253,0.5)] uppercase">IT&apos;S JUST FINANCE</h2>
            <span className="text-blue-300 text-sm font-mono tracking-wider animate-pulse drop-shadow-[0_0_2px_rgba(147,197,253,0.5)]">FINANCE RUNS EVERYTHING</span>
          </div>
