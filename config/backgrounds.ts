...
export const backgrounds: Background[] = [
  ...
  { id: 2, path: 'https://res.cloudinary.com/dfjqqnv3x/image/upload/v1751046722/bg22.png' },
  { id: 3, path: 'https://res.cloudinary.com/dfjqqnv3x/image/upload/v1751046727/bg3.png' },
